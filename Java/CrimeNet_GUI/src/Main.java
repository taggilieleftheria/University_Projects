...
public class Main {
	...
	public static void main(String[] args)  {
		...
		numbers.add("00496955444444");
		numbers.add("00496955333333");
		numbers.add("00446999888888");
		numbers.add("00478484777777");
		numbers.add("00478484666666");
		numbers.add("00478484222222");
